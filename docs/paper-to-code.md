...
| Sec. 2.2, Fig. 3 | Generation/verification TTC tree | v1 synthetic: `workload/schema.py`; v2: `schema_v2.py`, `io_v2.py`, `migration.py`, `replay_v2.py` | Exact-token round trip and per-token replay; width 4; beam 3; multi-parent KV; scalar/pairwise verifier | M4B.2 functional replay complete; real collectors pending |
