...
| 论文位置 | 论文机制 | 计划实现 |
|---|---|---|
| Sec. 2.2, Fig. 3 | generation/verification TTC tree | `collectors/policy_events.py`, `compute_optimal_tts.py`, policy/TTC schemas, `replay_v2.py`；generation 与 opaque PRM selection 已接通，PRM tensors/scores 待实现 |
